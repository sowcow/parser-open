class Stroitel
  ...
  def perform
    collect_links 'http://stroitel.sro-stroyproekt.com/reestr/easytablerecord/8-reestr-deistvuyuschih-chlenov-partnerstva', '#reestr-deistvuyuschih-chlenov-partnerstva' # Сбор ссылок
